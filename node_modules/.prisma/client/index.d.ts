...
/**
   ...
   * `prisma.preference`: Exposes CRUD operations for the **Preference** model.
    ...
    * ```
    */
  get preference(): Prisma.PreferenceDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type VolunteerCountOutputTypeSelect = {
    preferences?: boolean
  }

  export type VolunteerCountOutputTypeGetPayload<S extends boolean | null | undefined | VolunteerCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? VolunteerCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (VolunteerCountOutputTypeArgs)
    ? VolunteerCountOutputType 
    : S extends { select: any } & (VolunteerCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof VolunteerCountOutputType ? VolunteerCountOutputType[P] : never
  } 
      : VolunteerCountOutputType
   ...
   */
  export type VolunteerCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the VolunteerCountOutputType
     */
    select?: VolunteerCountOutputTypeSelect | null
  }
  ...
  export class Prisma__ParticipantClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    labels<T extends Participant$labelsArgs= {}>(args?: Subset<T, Participant$labelsArgs>): Prisma.PrismaPromise<Array<LabelGetPayload<T>>| Null>;
  ...
  export type LabelGetPayload<S extends boolean | null | undefined | LabelArgs> =
    ...
    : S extends { select: any } & (LabelArgs | LabelFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'participant' ? ParticipantGetPayload<S['select'][P]> :  P extends keyof Label ? Label[P] : never
  } 
      : Label
  ...
  export type VolunteerMinAggregateOutputType = {
    ...
    canLiftHeavyStuff: boolean | null
    ...
    canCleanupAfterShow: boolean | null
  ...
  export type VolunteerSelect = {
    ...
    isAvailableOnFriday?: boolean
    isAvailableOnSaturday?: boolean
    preferences?: boolean | Volunteer$preferencesArgs
    _count?: boolean | VolunteerCountOutputTypeArgs
  }
  ...
  export type VolunteerGetPayload<S extends boolean | null | undefined | VolunteerArgs> =
    ...
    ? Volunteer  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'preferences' ? Array < PreferenceGetPayload<S['include'][P]>>  :
        P extends '_count' ? VolunteerCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (VolunteerArgs | VolunteerFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'preferences' ? Array < PreferenceGetPayload<S['select'][P]>>  :
        P extends '_count' ? VolunteerCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Volunteer ? Volunteer[P] : never
  } 
      : Volunteer
  ...
  export class Prisma__VolunteerClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    preferences<T extends Volunteer$preferencesArgs= {}>(args?: Subset<T, Volunteer$preferencesArgs>): Prisma.PrismaPromise<Array<PreferenceGetPayload<T>>| Null>;
   ...
   */
  export type Volunteer$preferencesArgs = {
    /**
     * Select specific fields to fetch from the Preference
     */
    select?: PreferenceSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: PreferenceInclude | null
    where?: PreferenceWhereInput
    orderBy?: Enumerable<PreferenceOrderByWithRelationInput>
    cursor?: PreferenceWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<PreferenceScalarFieldEnum>
  }
  ...
  export type PreferenceGroupByArgs = {
    where?: PreferenceWhereInput
    orderBy?: Enumerable<PreferenceOrderByWithAggregationInput>
    by: PreferenceScalarFieldEnum[]
  ...
  type GetPreferenceGroupByPayload<T extends PreferenceGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<PreferenceGroupByOutputType, T['by']> &
        {
  ...
  export type PreferenceSelect = {
    ...
    label?: boolean
    emoji?: boolean
    volunteerInt?: boolean
    Volunteer?: boolean | VolunteerArgs
  }
  ...
  export type PreferenceGetPayload<S extends boolean | null | undefined | PreferenceArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Preference :
    S extends undefined ? never :
    S extends { include: any } & (PreferenceArgs | PreferenceFindManyArgs)
    ? Preference  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'Volunteer' ? VolunteerGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (PreferenceArgs | PreferenceFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'Volunteer' ? VolunteerGetPayload<S['select'][P]> | null :  P extends keyof Preference ? Preference[P] : never
  } 
      : Preference


  type PreferenceCountArgs = 
    Omit<PreferenceFindManyArgs, 'select' | 'include'> & {
      select?: PreferenceCountAggregateInputType | true
    }

  export interface PreferenceDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends PreferenceFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, PreferenceFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Preference'> extends True ? Prisma__PreferenceClient<PreferenceGetPayload<T>> : Prisma__PreferenceClient<PreferenceGetPayload<T> | null, null>
    ...
    **/
    findUniqueOrThrow<T extends PreferenceFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, PreferenceFindUniqueOrThrowArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends PreferenceFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, PreferenceFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Preference'> extends True ? Prisma__PreferenceClient<PreferenceGetPayload<T>> : Prisma__PreferenceClient<PreferenceGetPayload<T> | null, null>
    ...
    **/
    findFirstOrThrow<T extends PreferenceFindFirstOrThrowArgs>(
      args?: SelectSubset<T, PreferenceFindFirstOrThrowArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
    ...
    **/
    findMany<T extends PreferenceFindManyArgs>(
      args?: SelectSubset<T, PreferenceFindManyArgs>
    ): Prisma.PrismaPromise<Array<PreferenceGetPayload<T>>>
    ...
    **/
    create<T extends PreferenceCreateArgs>(
      args: SelectSubset<T, PreferenceCreateArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
    ...
    **/
    createMany<T extends PreferenceCreateManyArgs>(
      args?: SelectSubset<T, PreferenceCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
    ...
    **/
    delete<T extends PreferenceDeleteArgs>(
      args: SelectSubset<T, PreferenceDeleteArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
    ...
    **/
    update<T extends PreferenceUpdateArgs>(
      args: SelectSubset<T, PreferenceUpdateArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
    ...
    **/
    deleteMany<T extends PreferenceDeleteManyArgs>(
      args?: SelectSubset<T, PreferenceDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends PreferenceUpdateManyArgs>(
      args: SelectSubset<T, PreferenceUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends PreferenceUpsertArgs>(
      args: SelectSubset<T, PreferenceUpsertArgs>
    ): Prisma__PreferenceClient<PreferenceGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__PreferenceClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    Volunteer<T extends VolunteerArgs= {}>(args?: Subset<T, VolunteerArgs>): Prisma__VolunteerClient<VolunteerGetPayload<T> | Null>;
  ...
  /**
   * Preference base type for findUnique actions
   */
  export type PreferenceFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Preference
     */
    select?: PreferenceSelect | null
   ...
   */
  export interface PreferenceFindUniqueArgs extends PreferenceFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Preference base type for findFirst actions
   */
  export type PreferenceFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Preference
     */
    select?: PreferenceSelect | null
   ...
   */
  export interface PreferenceFindFirstArgs extends PreferenceFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  export type PreferenceCreateManyArgs = {
     ...
     */
    data: Enumerable<PreferenceCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export const VolunteerScalarFieldEnum: {
    ...
    canLiftHeavyStuff: 'canLiftHeavyStuff',
    isSocial: 'isSocial',
    ...
    canCleanupAfterShow: 'canCleanupAfterShow',
  ...
  export type VolunteerWhereInput = {
    ...
    hasDrivingLicense?: BoolFilter | boolean
    canCarryHeavyStuff?: BoolFilter | boolean
    canLiftHeavyStuff?: BoolFilter | boolean
    ...
    canCleanupAfterShow?: BoolFilter | boolean
  ...
  export type VolunteerScalarWhereWithAggregatesInput = {
    ...
    hasDrivingLicense?: BoolWithAggregatesFilter | boolean
    canCarryHeavyStuff?: BoolWithAggregatesFilter | boolean
    canLiftHeavyStuff?: BoolWithAggregatesFilter | boolean
    ...
    canCleanupAfterShow?: BoolWithAggregatesFilter | boolean
  ...
  export type PreferenceWhereInput = {
    AND?: Enumerable<PreferenceWhereInput>
    OR?: Enumerable<PreferenceWhereInput>
    NOT?: Enumerable<PreferenceWhereInput>
    id?: IntFilter | number
    key?: StringFilter | string
    label?: StringFilter | string
    emoji?: StringFilter | string
    volunteerInt?: IntNullableFilter | number | null
    Volunteer?: XOR<VolunteerRelationFilter, VolunteerWhereInput> | null
  }
  ...
  export type PreferenceScalarWhereWithAggregatesInput = {
    AND?: Enumerable<PreferenceScalarWhereWithAggregatesInput>
    OR?: Enumerable<PreferenceScalarWhereWithAggregatesInput>
    NOT?: Enumerable<PreferenceScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    key?: StringWithAggregatesFilter | string
    label?: StringWithAggregatesFilter | string
    emoji?: StringWithAggregatesFilter | string
    volunteerInt?: IntNullableWithAggregatesFilter | number | null
  }
  ...
  export type ParticipantCreateInput = {
    ...
    labels?: LabelCreateNestedManyWithoutParticipantInput
  }
  ...
  export type ParticipantUncheckedCreateInput = {
    ...
    labels?: LabelUncheckedCreateNestedManyWithoutParticipantInput
  }
  ...
  export type ParticipantUpdateInput = {
    ...
    labels?: LabelUpdateManyWithoutParticipantNestedInput
  }
  ...
  export type ParticipantUncheckedUpdateInput = {
    ...
    labels?: LabelUncheckedUpdateManyWithoutParticipantNestedInput
  }
  ...
  export type VolunteerCreateInput = {
    ...
    isAvailableOnFriday?: boolean
    isAvailableOnSaturday?: boolean
    preferences?: PreferenceCreateNestedManyWithoutVolunteerInput
  }
  ...
  export type VolunteerUncheckedCreateInput = {
    ...
    isAvailableOnFriday?: boolean
    isAvailableOnSaturday?: boolean
    preferences?: PreferenceUncheckedCreateNestedManyWithoutVolunteerInput
  }
  ...
  export type VolunteerUpdateInput = {
    ...
    hasDrivingLicense?: BoolFieldUpdateOperationsInput | boolean
    canCarryHeavyStuff?: BoolFieldUpdateOperationsInput | boolean
    canLiftHeavyStuff?: BoolFieldUpdateOperationsInput | boolean
  ...
  export type VolunteerUncheckedUpdateInput = {
    ...
    isAvailableOnFriday?: BoolFieldUpdateOperationsInput | boolean
    isAvailableOnSaturday?: BoolFieldUpdateOperationsInput | boolean
    preferences?: PreferenceUncheckedUpdateManyWithoutVolunteerNestedInput
  }
  ...
  export type PreferenceCreateInput = {
    ...
    label: string
    emoji: string
    Volunteer?: VolunteerCreateNestedOneWithoutPreferencesInput
  }
  ...
  export type PreferenceUpdateInput = {
    ...
    Volunteer?: VolunteerUpdateOneWithoutPreferencesNestedInput
  }
  ...
  export type PreferenceUncheckedUpdateInput = {
    ...
    label?: StringFieldUpdateOperationsInput | string
    emoji?: StringFieldUpdateOperationsInput | string
    volunteerInt?: NullableIntFieldUpdateOperationsInput | number | null
  }
  ...
  export type LabelCreateNestedManyWithoutParticipantInput = {
    create?: XOR<Enumerable<LabelCreateWithoutParticipantInput>, Enumerable<LabelUncheckedCreateWithoutParticipantInput>>
    connectOrCreate?: Enumerable<LabelCreateOrConnectWithoutParticipantInput>
    createMany?: LabelCreateManyParticipantInputEnvelope
  ...
  export type LabelUncheckedCreateNestedManyWithoutParticipantInput = {
    create?: XOR<Enumerable<LabelCreateWithoutParticipantInput>, Enumerable<LabelUncheckedCreateWithoutParticipantInput>>
    connectOrCreate?: Enumerable<LabelCreateOrConnectWithoutParticipantInput>
    createMany?: LabelCreateManyParticipantInputEnvelope
    connect?: Enumerable<LabelWhereUniqueInput>
  ...
  export type LabelUpdateManyWithoutParticipantNestedInput = {
    create?: XOR<Enumerable<LabelCreateWithoutParticipantInput>, Enumerable<LabelUncheckedCreateWithoutParticipantInput>>
    connectOrCreate?: Enumerable<LabelCreateOrConnectWithoutParticipantInput>
    upsert?: Enumerable<LabelUpsertWithWhereUniqueWithoutParticipantInput>
    createMany?: LabelCreateManyParticipantInputEnvelope
    set?: Enumerable<LabelWhereUniqueInput>
    disconnect?: Enumerable<LabelWhereUniqueInput>
    delete?: Enumerable<LabelWhereUniqueInput>
    connect?: Enumerable<LabelWhereUniqueInput>
    update?: Enumerable<LabelUpdateWithWhereUniqueWithoutParticipantInput>
    updateMany?: Enumerable<LabelUpdateManyWithWhereWithoutParticipantInput>
  ...
  export type LabelUncheckedUpdateManyWithoutParticipantNestedInput = {
    create?: XOR<Enumerable<LabelCreateWithoutParticipantInput>, Enumerable<LabelUncheckedCreateWithoutParticipantInput>>
    connectOrCreate?: Enumerable<LabelCreateOrConnectWithoutParticipantInput>
    upsert?: Enumerable<LabelUpsertWithWhereUniqueWithoutParticipantInput>
    createMany?: LabelCreateManyParticipantInputEnvelope
  ...
  export type PreferenceCreateNestedManyWithoutVolunteerInput = {
    create?: XOR<Enumerable<PreferenceCreateWithoutVolunteerInput>, Enumerable<PreferenceUncheckedCreateWithoutVolunteerInput>>
    connectOrCreate?: Enumerable<PreferenceCreateOrConnectWithoutVolunteerInput>
    createMany?: PreferenceCreateManyVolunteerInputEnvelope
    connect?: Enumerable<PreferenceWhereUniqueInput>
  }

  export type PreferenceUncheckedCreateNestedManyWithoutVolunteerInput = {
    create?: XOR<Enumerable<PreferenceCreateWithoutVolunteerInput>, Enumerable<PreferenceUncheckedCreateWithoutVolunteerInput>>
    connectOrCreate?: Enumerable<PreferenceCreateOrConnectWithoutVolunteerInput>
    createMany?: PreferenceCreateManyVolunteerInputEnvelope
    connect?: Enumerable<PreferenceWhereUniqueInput>
  ...
  export type PreferenceUpdateManyWithoutVolunteerNestedInput = {
    create?: XOR<Enumerable<PreferenceCreateWithoutVolunteerInput>, Enumerable<PreferenceUncheckedCreateWithoutVolunteerInput>>
    connectOrCreate?: Enumerable<PreferenceCreateOrConnectWithoutVolunteerInput>
    upsert?: Enumerable<PreferenceUpsertWithWhereUniqueWithoutVolunteerInput>
    createMany?: PreferenceCreateManyVolunteerInputEnvelope
    set?: Enumerable<PreferenceWhereUniqueInput>
    disconnect?: Enumerable<PreferenceWhereUniqueInput>
    delete?: Enumerable<PreferenceWhereUniqueInput>
    connect?: Enumerable<PreferenceWhereUniqueInput>
    update?: Enumerable<PreferenceUpdateWithWhereUniqueWithoutVolunteerInput>
    updateMany?: Enumerable<PreferenceUpdateManyWithWhereWithoutVolunteerInput>
    deleteMany?: Enumerable<PreferenceScalarWhereInput>
  }

  export type PreferenceUncheckedUpdateManyWithoutVolunteerNestedInput = {
    create?: XOR<Enumerable<PreferenceCreateWithoutVolunteerInput>, Enumerable<PreferenceUncheckedCreateWithoutVolunteerInput>>
    connectOrCreate?: Enumerable<PreferenceCreateOrConnectWithoutVolunteerInput>
    upsert?: Enumerable<PreferenceUpsertWithWhereUniqueWithoutVolunteerInput>
    createMany?: PreferenceCreateManyVolunteerInputEnvelope
  ...
  export type VolunteerCreateNestedOneWithoutPreferencesInput = {
    create?: XOR<VolunteerCreateWithoutPreferencesInput, VolunteerUncheckedCreateWithoutPreferencesInput>
    connectOrCreate?: VolunteerCreateOrConnectWithoutPreferencesInput
    connect?: VolunteerWhereUniqueInput
  }

  export type VolunteerUpdateOneWithoutPreferencesNestedInput = {
    create?: XOR<VolunteerCreateWithoutPreferencesInput, VolunteerUncheckedCreateWithoutPreferencesInput>
    connectOrCreate?: VolunteerCreateOrConnectWithoutPreferencesInput
    upsert?: VolunteerUpsertWithoutPreferencesInput
    disconnect?: boolean
    delete?: boolean
    connect?: VolunteerWhereUniqueInput
    update?: XOR<VolunteerUpdateWithoutPreferencesInput, VolunteerUncheckedUpdateWithoutPreferencesInput>
  }
...
>>>>>>> origin/HEAD
  ...
  export type LabelCreateWithoutParticipantInput = {
    label: string
    color?: string | null
  }

  export type LabelUncheckedCreateWithoutParticipantInput = {
    id?: number
    label: string
    color?: string | null
  }

  export type LabelCreateOrConnectWithoutParticipantInput = {
    where: LabelWhereUniqueInput
    create: XOR<LabelCreateWithoutParticipantInput, LabelUncheckedCreateWithoutParticipantInput>
  }

  export type LabelCreateManyParticipantInputEnvelope = {
    data: Enumerable<LabelCreateManyParticipantInput>
    skipDuplicates?: boolean
  }
  ...
  export type LabelUpsertWithWhereUniqueWithoutParticipantInput = {
    where: LabelWhereUniqueInput
    update: XOR<LabelUpdateWithoutParticipantInput, LabelUncheckedUpdateWithoutParticipantInput>
    create: XOR<LabelCreateWithoutParticipantInput, LabelUncheckedCreateWithoutParticipantInput>
  }

  export type LabelUpdateWithWhereUniqueWithoutParticipantInput = {
    where: LabelWhereUniqueInput
    data: XOR<LabelUpdateWithoutParticipantInput, LabelUncheckedUpdateWithoutParticipantInput>
  }

  export type LabelUpdateManyWithWhereWithoutParticipantInput = {
  ...
  export type PreferenceCreateWithoutVolunteerInput = {
    key: string
    label: string
    emoji: string
  }

  export type PreferenceUncheckedCreateWithoutVolunteerInput = {
    id?: number
    key: string
    label: string
    emoji: string
  ...
  export type PreferenceCreateOrConnectWithoutVolunteerInput = {
    where: PreferenceWhereUniqueInput
    create: XOR<PreferenceCreateWithoutVolunteerInput, PreferenceUncheckedCreateWithoutVolunteerInput>
  }

  export type PreferenceCreateManyVolunteerInputEnvelope = {
    data: Enumerable<PreferenceCreateManyVolunteerInput>
    skipDuplicates?: boolean
  }

  export type PreferenceUpsertWithWhereUniqueWithoutVolunteerInput = {
    where: PreferenceWhereUniqueInput
    update: XOR<PreferenceUpdateWithoutVolunteerInput, PreferenceUncheckedUpdateWithoutVolunteerInput>
    create: XOR<PreferenceCreateWithoutVolunteerInput, PreferenceUncheckedCreateWithoutVolunteerInput>
  }

  export type PreferenceUpdateWithWhereUniqueWithoutVolunteerInput = {
    where: PreferenceWhereUniqueInput
    data: XOR<PreferenceUpdateWithoutVolunteerInput, PreferenceUncheckedUpdateWithoutVolunteerInput>
  }

  export type PreferenceUpdateManyWithWhereWithoutVolunteerInput = {
    where: PreferenceScalarWhereInput
    data: XOR<PreferenceUpdateManyMutationInput, PreferenceUncheckedUpdateManyWithoutPreferencesInput>
  }

  export type PreferenceScalarWhereInput = {
    AND?: Enumerable<PreferenceScalarWhereInput>
    OR?: Enumerable<PreferenceScalarWhereInput>
    NOT?: Enumerable<PreferenceScalarWhereInput>
    id?: IntFilter | number
    key?: StringFilter | string
    label?: StringFilter | string
    emoji?: StringFilter | string
  ...
  export type VolunteerCreateWithoutPreferencesInput = {
    fullName: string
    mailAddress: string
    phoneNumber: string
    canCook?: boolean
  ...
  export type VolunteerUncheckedCreateWithoutPreferencesInput = {
    int?: number
    fullName: string
    mailAddress: string
    phoneNumber: string
  ...
  export type VolunteerCreateOrConnectWithoutPreferencesInput = {
    where: VolunteerWhereUniqueInput
    create: XOR<VolunteerCreateWithoutPreferencesInput, VolunteerUncheckedCreateWithoutPreferencesInput>
  }

  export type VolunteerUpsertWithoutPreferencesInput = {
    update: XOR<VolunteerUpdateWithoutPreferencesInput, VolunteerUncheckedUpdateWithoutPreferencesInput>
    create: XOR<VolunteerCreateWithoutPreferencesInput, VolunteerUncheckedCreateWithoutPreferencesInput>
  }

  export type VolunteerUpdateWithoutPreferencesInput = {
    fullName?: StringFieldUpdateOperationsInput | string
    mailAddress?: StringFieldUpdateOperationsInput | string
    phoneNumber?: StringFieldUpdateOperationsInput | string
    canCook?: BoolFieldUpdateOperationsInput | boolean
  ...
  export type VolunteerUncheckedUpdateWithoutPreferencesInput = {
    int?: IntFieldUpdateOperationsInput | number
    fullName?: StringFieldUpdateOperationsInput | string
    mailAddress?: StringFieldUpdateOperationsInput | string
    phoneNumber?: StringFieldUpdateOperationsInput | string
  ...
  export type LabelCreateManyParticipantInput = {
    id?: number
    label: string
    color?: string | null
  }
  ...
  export type LabelUpdateWithoutParticipantInput = {
    label?: StringFieldUpdateOperationsInput | string
    color?: NullableStringFieldUpdateOperationsInput | string | null
  }

  export type LabelUncheckedUpdateWithoutParticipantInput = {
    id?: IntFieldUpdateOperationsInput | number
    label?: StringFieldUpdateOperationsInput | string
    color?: NullableStringFieldUpdateOperationsInput | string | null
  }
  ...
  export type PreferenceCreateManyVolunteerInput = {
    id?: number
    key: string
    label: string
    emoji: string
  ...
  export type PreferenceUpdateWithoutVolunteerInput = {
    key?: StringFieldUpdateOperationsInput | string
    label?: StringFieldUpdateOperationsInput | string
    emoji?: StringFieldUpdateOperationsInput | string
  }

  export type PreferenceUncheckedUpdateWithoutVolunteerInput = {
    id?: IntFieldUpdateOperationsInput | number
    key?: StringFieldUpdateOperationsInput | string
    label?: StringFieldUpdateOperationsInput | string
    emoji?: StringFieldUpdateOperationsInput | string
  ...
  export type PreferenceUncheckedUpdateManyWithoutPreferencesInput = {
    id?: IntFieldUpdateOperationsInput | number
    key?: StringFieldUpdateOperationsInput | string
    label?: StringFieldUpdateOperationsInput | string
    emoji?: StringFieldUpdateOperationsInput | string
