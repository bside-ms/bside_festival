...
import type { DeleteSlotRequest, SuccessfulDeleteSlotResponse } from '_pages/api/applications/slot/delete';
import type { ErroneousUpdateSlotResponse, SuccessfulUpdateSlotResponse, UpsertSlotRequest } from '_pages/api/applications/slot/update';
