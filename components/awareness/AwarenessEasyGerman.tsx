    ...
    return (
        <div className="flex flex-col gap-5 bg-white p-4 drop-shadow-2xl">
            ...
            <div className="font-sans">
                ...
                <br />
                <br />
                <strong>Wird eine Grenze von dir überschritten?</strong>
                <br />
                <strong>Wird die Grenze von jemand anderem überschritten?</strong>
                <br />
                <strong>Dann kannst du etwas machen:</strong>
                <br />
                <br />
                <span className="text-xl">1.</span>
                <br />
                ...
                <br />
                Dort siehst du ein Schild, auf dem <strong>Awareness</strong> steht.
                <br />
                <br />
