...
export default async (): Promise<ReactElement> => {
    return (
        <>
            <Image src={MobileStage} alt="Festival-Logo" className="absolute top-[175px] -z-1 w-screen md:hidden" />
            ...
            <div className="relative mx-auto w-full max-w-2xl min-w-[300px] p-5 font-display md:p-8">
                ...
                <div className="mt-10 flex flex-col items-center text-4xl font-black sm:text-6xl">
                ...
                <div className="mx-6 mt-4 text-center">
                    ...
                    <div className="text-xs">→ Dann bewirb dich jetzt für das B‑Side Festival 2026!</div>
                </div>
                ...
                <div className="grid grid-cols-1 text-center md:grid-cols-5 md:text-left">
                    <div className="col-span-2 flex flex-col items-center justify-center">
                        {isWithinApplicationPhase() && (
                            <Link href="/bewerbungen" className="mr-4 underline">
                                <Image src={ApplyNow} alt="Jetzt Bewerben" className="m-5 w-[200px]" />
                            </Link>
                        )}
                    </div>
                    ...
                    <div className="col-span-3 text-xs">
                        <div className="mt-4">
                            <span className="text-sm font-black">Wann?</span> 18.–19. September 2026
                        </div>
                        <div className="mt-4">
                            <span className="text-sm font-black">Wo?</span> Mittelhafen & Hansaviertel Münster
                        </div>
                        <div className="mt-4">
                            <span className="text-sm font-black">Wen suchen wir?</span> Bands, Musiker:innen, Künstler:innen,
                            ...
                            <div className="mt-2">Ob professionell oder aus Leidenschaft – all welcome.</div>
                            <div className="mt-2">
                                Egal ob Bühne, Raum, Installation oder etwas ganz anderes: Wir sind gespannt auf das, was wir noch nicht
                                kennen.
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="text-xs">19. April bis 10. Mai</div>
                        </div>
