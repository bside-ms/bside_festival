...
export const updateApplicationName = loggedAction(
    'updateApplicationName',
    async (id: number, values: z.infer<typeof updateApplicationNameSchema>): Promise<void> => {
...
export const updateApplicationDescription = loggedAction(
    'updateApplicationDescription',
    async (id: number, values: z.infer<typeof updateApplicationDescriptionSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const updateApplicationMotivation = loggedAction(
    'updateApplicationMotivation',
    async (id: number, values: z.infer<typeof updateApplicationMotivationSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
        ...
        await prismaClient.$transaction(async (tx) => {
            const application = await tx.participant.findUniqueOrThrow({
                select: { id: true, motivation: true, name: true },
                where: { id },
            });
            const changes = filterChanges([
...
export const updateApplicationParticipantCount = loggedAction(
    'updateApplicationParticipantCount',
    async (id: number, values: z.infer<typeof updateApplicationParticipantCountSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const updateApplicationDurationPreference = loggedAction(
    'updateApplicationDurationPreference',
    async (id: number, values: z.infer<typeof updateApplicationDurationPreferenceSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const updateApplicationPastParticipation = loggedAction(
    'updateApplicationPastParticipation',
    async (id: number, values: z.infer<typeof updateApplicationPastParticipationSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const updateApplicationJuryVotes = loggedAction(
    'updateApplicationJuryVotes',
    async (id: number, values: z.infer<typeof updateApplicationJuryVotesSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
        ...
        await prismaClient.$transaction(async (tx) => {
            const application = await tx.participant.findUniqueOrThrow({
                select: { id: true, juryVotes: true, name: true },
                where: { id },
            });
...
export const updateApplicationBookingInfo = loggedAction(
    'updateApplicationBookingInfo',
    async (id: number, values: z.infer<ReturnType<typeof createUpdateApplicationBookingInfoSchema>>): Promise<void> => {
        const actor = await requireLoggedInUser();
        const { participantCount } = await prismaClient.participant.findUniqueOrThrow({
...
export const updateApplicationDiversityInfo = loggedAction(
    'updateApplicationDiversityInfo',
    async (id: number, values: z.infer<ReturnType<typeof createUpdateApplicationDiversityInfoSchema>>): Promise<void> => {
        const actor = await requireLoggedInUser();
        const { participantCount } = await prismaClient.participant.findUniqueOrThrow({
            select: { participantCount: true },
            where: { id },
        ...
        await prismaClient.$transaction(async (tx) => {
            ...
            const changes = filterChanges([
                ...
                createChange(
                    'diversityNotes',
                    'Diversitätsnotizen',
                    application.diversityNotes,
                    normalizedDiversityNotes,
                    formatNullableText,
                ),
            ]);
...
export const updateApplicationAdditionalInfo = loggedAction(
    'updateApplicationAdditionalInfo',
    async (id: number, values: z.infer<typeof updateApplicationAdditionalInfoSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const updateApplicationContactInfo = loggedAction(
    'updateApplicationContactInfo',
    async (id: number, values: z.infer<typeof updateApplicationContactInfoSchema>): Promise<void> => {
...
export const deleteApplicationImage = loggedAction(
    ...
    (id) => applicationActionMeta(id),
);

export const replaceApplicationImage = loggedAction(
    ...
    (id) => applicationActionMeta(id, { hasEncodedImage: true }),
);

export const setApplicationStatus = loggedAction(
    'setApplicationStatus',
    async (id: number, applicationStatus: ApplicationStatus, commentText?: string): Promise<void> => {
        const actor = await requireLoggedInUser();
        ...
        await prismaClient.$transaction(async (tx) => {
            ...
            const changes = filterChanges([
                createChange('status', 'Status', application.status, applicationStatus, formatApplicationStatus),
            ]);
    ...
    (id, applicationStatus, commentText) => applicationActionMeta(id, { applicationStatus, hasComment: Boolean(commentText) }),
);
...
export const addComment = loggedAction(
    'addComment',
    ...
    (id) => applicationActionMeta(id, { hasText: true }),
);
...
export const updateApplicationFeeEuros = loggedAction(
    'updateApplicationFeeEuros',
    async (id: number, values: z.infer<typeof updateApplicationFeeEurosSchema>): Promise<void> => {
        const actor = await requireLoggedInUser();
...
export const setApplicationOrganizers = loggedAction(
    'setApplicationOrganizers',
    async (participantId: number, organizers: Array<{ organizerName: string; organizerUserId: string }>): Promise<void> => {
        const actor = await requireLoggedInUser();
        ...
        await prismaClient.$transaction(async (tx) => {
            ...
            const changes = filterChanges([
                createChange('organizers', 'Zuständigkeit', previousOrganizers, nextOrganizers, formatOrganizers),
            ]);
