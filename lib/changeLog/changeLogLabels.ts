...
export const changeLogActionLabels: Record<ChangeLogAction, string> = {
    ...
    [ChangeLogAction.ApplicationTypeAndGenresUpdated]: 'Typ und Genres geändert',
    [ChangeLogAction.ApplicationLinksUpdated]: 'Links geändert',
    [ChangeLogAction.ApplicationZipcodesUpdated]: 'Wohnorte geändert',
    [ChangeLogAction.ApplicationTechnicalRiderUpdated]: 'Technical Rider geändert',
    [ChangeLogAction.ApplicationBacklineSharingUpdated]: 'Backline-Sharing geändert',
    [ChangeLogAction.ApplicationAllergiesUpdated]: 'Allergien geändert',
